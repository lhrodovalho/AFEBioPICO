...
N 13210 -8170 13210 -8140 { lab=GND}
N 13210 -8260 13210 -8230 { lab=in}
...
C {devices/vsource.sym} 13210 -8200 0 0 {name=V1 value=1 AC 1}
C {devices/gnd.sym} 13210 -8140 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} 13210 -8260 0 0 {name=l4 sig_type=std_logic lab=in
}
