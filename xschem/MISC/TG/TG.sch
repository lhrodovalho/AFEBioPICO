...
N 30 -180 30 -140 { lab=EN}
N 30 -60 30 -40 { lab=VDD}
N 30 -100 30 -80 { lab=VSS}
...
C {ARRAY/TG_n1_1.sym} 30 -120 1 0 {name=x1}
C {ARRAY/TG_p1_1.sym} 30 -20 1 1 {name=x2}
...
C {devices/lab_pin.sym} 30 -80 2 0 {name=l5 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 30 -60 0 0 {name=l6 sig_type=std_logic lab=VDD}
C {devices/iopin.sym} 190 -120 0 0 {name=p5 lab=VDD}
C {devices/iopin.sym} 190 -100 0 0 {name=p6 lab=VSS}
