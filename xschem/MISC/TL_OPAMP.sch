...
N 120 -450 220 -450 { lab=#net1}
N 460 -520 460 -480 { lab=VDD}
N 80 -520 260 -520 { lab=VDD}
N 80 -520 80 -480 { lab=VDD}
N 460 -420 460 -390 { lab=#net2}
N 170 -450 170 -380 { lab=#net1}
N 80 -380 170 -380 { lab=#net1}
...
N 460 -390 460 -340 { lab=#net2}
N 80 -420 80 -370 { lab=#net1}
N 260 -520 470 -520 { lab=VDD}
N 220 -450 430 -450 { lab=#net1}
N 360 -340 360 -320 { lab=#net2}
N 560 -340 560 -320 { lab=#net2}
N 400 -340 520 -340 { lab=#net2}
N 360 -260 360 -190 { lab=#net3}
N 560 -260 560 -190 { lab=OUT}
N 360 -340 400 -340 { lab=#net2}
N 520 -340 560 -340 { lab=#net2}
...
N 360 -230 460 -230 { lab=#net3}
N 460 -230 460 -160 { lab=#net3}
...
C {devices/vsource.sym} 760 -420 0 0 {name=V2 value=1.8}
C {devices/gnd.sym} 760 -390 0 0 {name=l7 lab=GND}
C {devices/vsource.sym} 690 -420 0 0 {name=V4 value=1.8}
