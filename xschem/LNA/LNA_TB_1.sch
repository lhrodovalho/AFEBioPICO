...
N 310 -260 370 -260 { lab=PLUS1}
N 210 -260 210 -240 { lab=PLUS1}
N 210 -180 210 -140 { lab=GND}
N 60 -260 120 -260 { lab=VP}
N 180 -450 290 -450 { lab=MINUS1}
N 230 -260 310 -260 { lab=PLUS1}
N 180 -260 230 -260 { lab=PLUS1}
N 10 -260 60 -260 { lab=VP}
N 330 -260 330 -240 { lab=PLUS1}
...
C {LNA/LNA_OPAMP_1.sym} 370 -220 0 0 {name=X1}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 150 -450 1 0 {name=C2 model=cap_mim_m3_1 W=22 L=22 MF=10 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 150 -260 1 0 {name=C3 model=cap_mim_m3_1 W=22 L=22 MF=10 spiceprefix=X}
...
C {devices/isource.sym} 850 -480 0 0 {name=I1 value=40n}
...
C {devices/lab_pin.sym} 330 -260 1 0 {name=l26 sig_type=std_logic lab=PLUS1}
