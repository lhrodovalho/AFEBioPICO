...
S {}
E {}
N 110 -650 210 -650 { lab=IBIAS}
N 70 -720 250 -720 { lab=VDD}
N 70 -720 70 -680 { lab=VDD}
N 160 -650 160 -580 { lab=IBIAS}
N 70 -580 160 -580 { lab=IBIAS}
N 50 -650 70 -650 { lab=VDD}
N 50 -720 50 -650 { lab=VDD}
N 50 -720 70 -720 { lab=VDD}
N 70 -620 70 -570 { lab=IBIAS}
...
N 590 -330 620 -330 { lab=VSS}
N 320 -140 350 -140 { lab=VSS}
N 70 -570 70 -350 { lab=IBIAS}
...
N 350 -720 550 -720 { lab=VDD}
N 160 -580 440 -580 { lab=IBIAS}
N 440 -650 440 -580 { lab=IBIAS}
N 440 -650 510 -650 { lab=IBIAS}
N 350 -650 380 -650 { lab=VDD}
N 380 -720 380 -650 { lab=VDD}
N 550 -650 580 -650 { lab=VDD}
N 550 -720 580 -720 { lab=VDD}
N 580 -720 580 -650 { lab=VDD}
N 1030 -320 1140 -320 { lab=VDD}
N 1030 -370 1140 -370 { lab=VSS}
...
C {devices/iopin.sym} 1450 -550 0 0 {name=p1 lab=VDD}
C {devices/iopin.sym} 1450 -520 0 0 {name=p2 lab=VSS}
C {devices/iopin.sym} 1450 -490 0 0 {name=p3 lab=PLUS}
C {devices/iopin.sym} 1450 -460 0 0 {name=p4 lab=MINUS}
C {devices/iopin.sym} 1450 -430 0 0 {name=p5 lab=OUT}
C {devices/iopin.sym} 1450 -400 0 0 {name=p6 lab=IBIAS}
C {devices/lab_pin.sym} 250 -750 1 0 {name=l3 sig_type=std_logic lab=VDD}
...
C {devices/lab_pin.sym} 1030 -320 0 0 {name=l4 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1030 -370 0 0 {name=l11 sig_type=std_logic lab=VSS}
...
C {ARRAY/p1_16.sym} 450 -410 3 0 {name=x17}
C {devices/lab_pin.sym} 450 -520 1 0 {name=l22 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 450 -390 3 0 {name=l23 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 450 -480 0 0 {name=l21 sig_type=std_logic lab=MINUS}
C {devices/lab_pin.sym} 450 -430 2 0 {name=l24 sig_type=std_logic lab=PLUS}
